...
const ManageAppointments = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      const response = await axios.get(`https://prowellness-eight.vercel.app/api/adminmanageappointments?email=${searchTerm}&status=${statusFilter}`);
  ...
  const handleCancelAppointment = async (appointmentId) => {
    try {
      ...
      await axios.get(`https://prowellness-eight.vercel.app/api/admincancelappointment?appointmentId=${appointmentId}`);
